...
export const INTERNALS=Object.freeze({
  gj_jiuyin:{name:'구음진경',kind:'내공',role:'균형·파훼',unlockLevel:8,unlock:{campaign:'sajo',clearedAny:['s7'],label:'도화도에서 주백통의 구음진경 전수'},source:'사조영웅전 · 도화도에서 주백통을 통해 상·하권을 외운 뒤 구음의 요체를 수련',desc:'강유를 고르게 운용해 명중과 파훼가 안정된다.',effects:{stats:{res:1,skl:1},hit:3,guardDamage:1,kiOnBreak:2}},
  gj_quanzhen:{name:'전진현문내공',kind:'내공',role:'지속전',unlock:{campaign:'sajo',reachedAny:['s3'],label:'몽골 초원에서 마옥의 전진 내공 수련'},source:'사조영웅전 · 마옥에게 전진교 내공의 기초를 전수받음',desc:'정순한 호흡으로 기력을 오래 유지한다.',effects:{stats:{def:1,ki:4},turnKi:1}},
  ...
  hy_jiuyin:{name:'구음요결',kind:'내공',role:'정신·회복',unlockLevel:8,unlock:{campaign:'sajo',clearedAny:['s7'],label:'도화도 이후 곽정과 구음 요결 연구'},source:'사조영웅전 이후 · 곽정과 함께 구음진경을 연구함',desc:'구음의 요결로 내력과 정신을 고르게 다스린다.',effects:{stats:{int:1,res:1},turnKi:1}},
  yg_heavy:{name:'중검무봉',kind:'특성',role:'중격·파훼',unlockLevel:10,unlock:{campaign:'sinjo',clearedAny:['s6'],label:'검총에서 현철중검과 해조 수련'},source:'신조협려 · 신조의 인도로 현철중검을 들고 해조와 폭포에서 수련',desc:'움직임을 줄이고 축적한 힘을 한 번에 쏟는다.',effects:{stationaryDamage:.18,guardDamage:1}},
  yg_yunu:{name:'옥녀심경',kind:'내공',role:'기동·연계',unlockLevel:4,unlock:{campaign:'sinjo',clearedAny:['s2'],label:'고묘에서 소용녀와 옥녀심경 합련'},source:'신조협려 · 소용녀와 함께 고묘파 옥녀심경을 수련',desc:'빠른 신법과 초식의 연결이 날카로워진다.',effects:{stats:{spd:1,skl:1},comboDamage:.08}},
  syn_yunu:{name:'옥녀심경',kind:'내공',role:'신속·회피',source:'신조협려 · 고묘파의 핵심 심법을 전승',desc:'가볍고 빠른 운기로 공격을 흘린다.',effects:{stats:{spd:1},avoid:8}},
  syn_dual:{name:'좌우쌍검',kind:'특성',role:'인연·연계',unlockLevel:10,unlock:{campaign:'sinjo',clearedAny:['s4'],label:'주백통에게 좌우호박을 배운 뒤 옥녀소심검 독전'},source:'신조협려 · 주백통에게 좌우호박을 익혀 옥녀소심검을 홀로 펼침',desc:'인연 협공과 서로 다른 초식의 연계가 강해진다.',effects:{bondDamage:.1,comboDamage:.08}},
  jmk_jiuyang:{name:'구양신공',kind:'내공',role:'회복·지속전',unlockLevel:7,unlock:{campaign:'uicheon',clearedAny:['s5'],label:'백원의 구양진경을 완성해 한독 극복'},source:'의천도룡기 · 백원 뱃속의 구양진경을 수련해 현명신장의 한독을 몰아냄',desc:'순양의 진기로 매 턴 체력과 기력을 회복한다.',effects:{stats:{res:1},turnHeal:2,turnKi:1}},
  jmk_qiankun:{name:'건곤대나이',kind:'심법',role:'전환·파훼',unlockLevel:9,unlock:{campaign:'uicheon',clearedAny:['s6a','s6b'],label:'광명정 밀도에서 건곤대나이 습득'},source:'의천도룡기 · 광명정 밀도에서 명교 호교신공을 익힘',desc:'상대의 힘을 이끌어 피해를 줄이고 강기를 무너뜨린다.',effects:{damageTaken:.1,guardDamage:1}},
  jmk_taiji:{name:'태극심의',kind:'심법',role:'수비·반격',unlockLevel:10,unlock:{campaign:'uicheon',clearedAny:['s8'],label:'무당산에서 장삼봉의 태극권검 전수'},source:'의천도룡기 · 장삼봉에게 태극권검의 후발제인 뜻을 전수받음',desc:'급히 맞서지 않고 빈틈을 기다려 회피와 명중을 얻는다.',effects:{avoid:6,hit:3,lowHpReduction:.08}},
  ...
  dy_beiming:{name:'북명신공',kind:'내공',role:'흡기·지속전',unlock:{campaign:'chunryong',reachedAny:['dy1'],label:'무량산 낭환복지에서 비권 발견'},source:'천룡팔부 · 무량산 낭환복지의 비권으로 북명신공을 익힘',desc:'공격이 적중할 때 상대의 기운을 끌어와 기력을 회복한다.',effects:{stats:{int:1},kiOnHit:2}},
  dy_lingbo:{name:'능파미보',kind:'경공',role:'기동·회피',unlock:{campaign:'chunryong',reachedAny:['dy1'],label:'무량산 비권의 주역 보법 습득'},source:'천룡팔부 · 북명신공과 함께 주역의 괘상을 밟는 능파미보를 익힘',desc:'이동력이 늘고 공격을 흘릴 가능성이 높아진다.',effects:{stats:{mov:1},avoid:10}},
  hj_beimingqi:{name:'북명진기',kind:'내공',role:'호체·지속전',unlock:{campaign:'chunryong',clearedAny:['hj1'],label:'진롱기국 뒤 무애자의 공력 전수'},source:'천룡팔부 · 무애자의 공력과 동모·이추수의 진기가 몸에 합쳐짐',desc:'깊은 진기가 몸을 보호하고 기력을 회복한다. 흡공 효과는 없다.',effects:{damageTaken:.1,turnKi:1}},
  hj_tianshan:{name:'천산절학',kind:'심법',role:'변화·연계',unlock:{campaign:'chunryong',clearedAny:['hj2'],label:'영취궁에서 천산동모의 절학 전수'},source:'천룡팔부 · 천산동모에게 천산절매수와 천산육양장을 전수받음',desc:'복잡한 변화를 이어 갈수록 초식의 위력이 높아진다.',effects:{hit:3,comboDamage:.1}},
...
export function internalUnlockState(item,campaign){
  const rule=item?.unlock;
  if(!rule||!campaign||campaign.camp!==rule.campaign)return {unlocked:true,label:''};
  const cleared=campaign.cleared||[],reached=[campaign.stageId,...cleared];
